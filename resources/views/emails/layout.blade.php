                                                            ...
                                                            <td valign="middle" style='vertical-align: middle;'>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                                                                        <h1 class='big'><a target='_blank' href="{{ url('/') }}" style='color:#444444'>Stticker.com</a></h1>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td width='10'></td>
                                                            <td valign="middle" style='vertical-align: middle;' width='150'>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable' style='text-align: right;'>
                                                                        <a target='_blank' href="{{ url('/') }}" class='link1' >Website</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <div class='contentEditableContainer contentTextEditable'>
                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                        <p>
                                                                            Copyright &copy; 2016 - Stticker.com
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentFacebookEditable'>
                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                        <img src="{{ asset("assets/images/facebook.png") }}" alt="facebook" width='40' height='40' data-max-width="40" data-customIcon="true" >
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td width='10'></td>
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentTwitterEditable'>
                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                        <img src="{{ asset("assets/images/twitter.png") }}" alt="twitter" width='40' height='40' data-max-width="40" data-customIcon="true">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td width='10'></td>
                                                            <td width='40'>
                                                                <div class='contentEditableContainer contentImageEditable'>
                                                                    <div class='contentEditable' style='text-align: center;color:#AAAAAA;'>
                                                                        <img src="{{ asset("assets/images/pinterest.png") }}" alt="Pinterest" width='40' height='40' data-max-width="40">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
